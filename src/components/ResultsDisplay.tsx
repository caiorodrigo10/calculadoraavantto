...
export const ResultsDisplay = ({ results, formData }: ResultsDisplayProps) => {
  ...
  return (
    <motion.div 
      className="space-y-6 w-full bg-white/80 backdrop-blur-sm text-gray-800 p-8 rounded-lg shadow-sm"
      variants={container}
      initial="hidden"
      animate="show"
    >
      <div className="flex justify-between items-center">
        ...
        <Button
          ...
          variant="outline"
          className="flex items-center gap-2 bg-white hover:bg-gray-50 text-gray-800 border-gray-200"
        >
      ...
      <div id="results-content" className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <motion.div variants={item}>
            <Card className="p-6 bg-white/50 backdrop-blur-sm border-gray-200 shadow-sm hover:shadow-md transition-all">
              <h3 className="text-lg font-semibold mb-2 text-gray-800">Cenário Atual</h3>
          ...
          <motion.div variants={item}>
            <Card className="p-6 bg-white/50 backdrop-blur-sm border-gray-200 shadow-sm hover:shadow-md transition-all">
              <h3 className="text-lg font-semibold mb-2 text-gray-800">Com IA</h3>
              <div className="space-y-2">
                <p className="flex justify-between">
