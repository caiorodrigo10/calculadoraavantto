      ...
      <Card className="p-4 sm:p-6 bg-white border border-green-200 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          <div className="space-y-3">
            ...
            <div>
              <p className="text-xl sm:text-2xl font-bold text-green-600">{Math.round(roi)}%</p>
              <p className="text-xs sm:text-sm text-gray-600">Retorno sobre investimento</p>
            </div>
            <div>
              <p className="text-xl sm:text-2xl font-bold text-green-600">{paybackPeriod} meses</p>
          ...
          <div className="space-y-3">
            ...
            <div>
              <p className="text-xl sm:text-2xl font-bold text-blue-600">-70%</p>
          ...
          <div className="space-y-3">
            ...
            <div>
              <p className="text-xl sm:text-2xl font-bold text-blue-600">+{additionalLeadsPerYear}</p>
